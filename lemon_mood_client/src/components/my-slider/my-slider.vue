<template>
  <div
    class="my-el-slider"
    :class="{ 'is-vertical': vertical, 'my-el-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="my-el-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="my-el-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="my-el-slider__stop my-el-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="my-el-slider__marks">
          <slider-marker
...
<style scoped src="./my-slider.css"/>
